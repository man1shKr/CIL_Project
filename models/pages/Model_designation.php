	...
	function __construct(){
		...
		public function get_values(){
			...
			// 	}
				...
				if($minecategory=="Partly Departmental & Partly Outsourced Mechanized Mixed Mines"||$minecategory=="Fully Departmental Mechanized Mixed Mines")
				{
			...
			$sql="SELECT xz.cadre AS cadre, yz.e1 - xz.e1 AS newe1,yz.e2 - xz.e2 AS newe2,yz.e3 - xz.e3 AS newe3,yz.e4 - xz.e4 AS newe4, yz.e5 - xz.e5 AS newe5, yz.e6 - xz.e6 AS newe6, yz.e7 - xz.e7 AS newe7, yz.e8 - xz.e8 AS newe8
				FROM (SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
			       ...
			       (SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
					...
					INNER JOIN cadre cd
					ON cd.sno = sm.cadre 
					WHERE a.sub_id=$sub_name AND a.area_id=$area_name AND a.subarea_id=$subarea_name AND a.year_id=$year_name AND a.production > b.plower_lim AND a.production <= b.pupper_lim
					...
					INNER JOIN cadre cd
					ON cd.sno = smd.cadre 
					WHERE a.sub_id=$sub_name AND a.area_id=$area_name AND a.subarea_id=$subarea_name AND a.year_id=$year_name AND a.production > b.plower_lim AND a.production <= b.pupper_lim  AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre UNION ALL
					-- SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
			        -- SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM mines a
					-- INNER JOIN minesubtype b
					-- ON a.mine_type = b.mine_id  
				    ...
				    -- a.mine_type = 2 AND a.production > b.plower_lim AND a.production <= b.pupper_lim AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre
					--  UNION ALL
			...
			$sql="SELECT xz.cadre AS cadre, yz.e1 - xz.e1 AS newe1,yz.e2 - xz.e2 AS newe2,yz.e3 - xz.e3 AS newe3,yz.e4 - xz.e4 AS newe4, yz.e5 - xz.e5 AS newe5, yz.e6 - xz.e6 AS newe6, yz.e7 - xz.e7 AS newe7, yz.e8 - xz.e8 AS newe8
				FROM (SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
			       ...
			       (SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
					...
					INNER JOIN cadre cd
					ON cd.sno = sm.cadre 
					WHERE a.sub_id=$sub_name AND a.area_id=$area_name AND a.year_id=$year_name AND a.production > b.plower_lim AND a.production <= b.pupper_lim
					GROUP BY sm.cadre  UNION ALL 
					SELECT cd.cil_cadre AS cadre, SUM(smd.E1) AS e1, SUM(smd.E2) AS e2, SUM(smd.E3) AS e3, SUM(smd.E4) 
					AS e4, 
					SUM(smd.E5) AS e5, SUM(smd.E6) AS e6, SUM(smd.E7) AS e7, SUM(smd.E8) AS e8 FROM mines a 
					...
					INNER JOIN cadre cd
					ON cd.sno = smd.cadre 
					WHERE a.sub_id=$sub_name AND a.area_id=$area_name AND a.year_id=$year_name AND a.production > b.plower_lim AND a.production <= b.pupper_lim  AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre UNION ALL
					-- SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
			        -- SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM mines a
					-- INNER JOIN minesubtype b
					-- ON a.mine_type = b.mine_id  
			...
			$sql="SELECT xz.cadre AS cadre, yz.e1 - xz.e1 AS newe1,yz.e2 - xz.e2 AS newe2,yz.e3 - xz.e3 AS newe3,yz.e4 - xz.e4 AS newe4, yz.e5 - xz.e5 AS newe5, yz.e6 - xz.e6 AS newe6, yz.e7 - xz.e7 AS newe7, yz.e8 - xz.e8 AS newe8
				FROM (SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
			       ...
			       (SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
					...
					INNER JOIN cadre cd
					ON cd.sno = sm.cadre 
					WHERE a.sub_id=$sub_name  AND a.year_id=$year_name  AND a.production > b.plower_lim AND a.production <= b.pupper_lim
					GROUP BY sm.cadre  UNION ALL 
					SELECT cd.cil_cadre AS cadre, SUM(smd.E1) AS e1, SUM(smd.E2) AS e2, SUM(smd.E3) AS e3, SUM(smd.E4) 
					AS e4, 
					SUM(smd.E5) AS e5, SUM(smd.E6) AS e6, SUM(smd.E7) AS e7, SUM(smd.E8) AS e8 FROM mines a 
					...
					INNER JOIN cadre cd
					ON cd.sno = smd.cadre 
					WHERE a.sub_id=$sub_name  AND a.year_id=$year_name  AND a.production > b.plower_lim AND a.production <= b.pupper_lim  AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre  UNION ALL
					-- SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
			        -- SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM mines a
					-- INNER JOIN minesubtype b
					-- ON a.mine_type = b.mine_id  
		...
		// ********************** Modification Required ********************************* 
		public function get_compare_for_CIL()
		{
			...
			$sql="SELECT xz.cadre AS cadre, yz.e1 - xz.e1 AS newe1,yz.e2 - xz.e2 AS newe2,yz.e3 - xz.e3 AS newe3,yz.e4 - xz.e4 AS newe4, yz.e5 - xz.e5 AS newe5, yz.e6 - xz.e6 AS newe6, yz.e7 - xz.e7 AS newe7, yz.e8 - xz.e8 AS newe8
				FROM (SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
			       ...
			       (SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
					...
					INNER JOIN cadre cd
					ON cd.sno = sm.cadre 
					 WHERE a.year_id=$year_name  AND a.production > b.plower_lim AND a.production <= b.pupper_lim
					GROUP BY sm.cadre  UNION ALL 
					SELECT cd.cil_cadre AS cadre, SUM(smd.E1) AS e1, SUM(smd.E2) AS e2, SUM(smd.E3) AS e3, SUM(smd.E4) 
					AS e4, 
					SUM(smd.E5) AS e5, SUM(smd.E6) AS e6, SUM(smd.E7) AS e7, SUM(smd.E8) AS e8 FROM mines a 
					...
					INNER JOIN cadre cd
					ON cd.sno = smd.cadre 
					WHERE  a.year_id=$year_name  AND a.production > b.plower_lim AND a.production <= b.pupper_lim  AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre  UNION ALL
					-- SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
			        -- SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM mines a
					-- INNER JOIN minesubtype b
					-- ON a.mine_type = b.mine_id  
			        ...
			        INNER JOIN cadre cd ON cd.sno = sm.cadre
			         GROUP BY sm.cadre UNION ALL
			         SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM cil_hq_standard sm
			        INNER JOIN cadre cd ON cd.sno=sm.cadre
			        GROUP BY sm.cadre
				    ) as y GROUP BY y.cadre ORDER BY y.cadre) AS xz
				INNER JOIN (SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
		...
		public function get_compare_for_CIL_hq()
		{
			$year_name=$this->input->post('year_name');
			...
			$sql="SELECT xz.cadre AS cadre, yz.e1 - xz.e1 AS newe1,yz.e2 - xz.e2 AS newe2,yz.e3 - xz.e3 AS newe3,yz.e4 - xz.e4 AS newe4, yz.e5 - xz.e5 AS newe5, yz.e6 - xz.e6 AS newe6, yz.e7 - xz.e7 AS newe7, yz.e8 - xz.e8 AS newe8
				FROM (SELECT cd.cil_cadre as cadre, em.E1 as e1, em.E2 as e2, em.E3 as e3, em.E4 as e4, em.E5 as e5, em.E6 as e6, em.E7 as e7, em.E8 as e8 FROM
					cil_hq_standard em
					INNER JOIN cadre cd ON cd.sno=em.cadre 
					 GROUP BY em.cadre ORDER BY cd.cil_cadre ASC) AS xz
				INNER JOIN (SELECT cd.cil_cadre as cadre, em.E1 as e1, em.E2 as e2, em.E3 as e3, em.E4 as e4, em.E5 as e5, em.E6 as e6, em.E7 as e7, em.E8 as e8 FROM
					cil_hq_existing em
					INNER JOIN cadre cd ON cd.sno=em.cadre WHERE
		...
		public function get_mine_for_subarea()
		{
			...
			$sql1= "SELECT y.cadre AS cadre, SUM(y.e1) AS e1, SUM(y.e2) AS e2, SUM(y.e3) AS e3, SUM(y.e4) AS e4,
			       ...
			       (SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
					...
					ON cd.sno = smd.cadre 
					WHERE a.sub_id=$sub_name AND a.area_id=$area_name AND a.subarea_id=$subarea_name AND a.year_id=$year_name AND   
				    a.production > b.plower_lim AND a.production <= b.pupper_lim  AND a.production > smd.min_prod AND a.production <= smd.max_prod GROUP BY smd.cadre UNION ALL
					-- SELECT cd.cil_cadre AS cadre, SUM(sm.E1) AS e1, SUM(sm.E2) AS e2, SUM(sm.E3) AS e3, SUM(sm.E4) AS e4, 
			        -- SUM(sm.E5) AS e5, SUM(sm.E6) AS e6, SUM(sm.E7) AS e7, SUM(sm.E8) AS e8 FROM mines a
					-- INNER JOIN minesubtype b
					-- ON a.mine_type = b.mine_id  

...
//Ankit
	...
	public function CIL_compare_data()
	{
		//$data['minecategory'] = $this->model_designation->fetch_minetype();
		//$data['sub_name']=$this->model_designation->fetch_subsidiary();
		$data['year_name']=$this->model_designation->fetch_year();

		$this->load->view('pages/CIL_compare_data',$data);
		$this->load->view('templates/footer');
	}

	public function CIL_hq_compare_data()
	{
		//$data['minecategory'] = $this->model_designation->fetch_minetype();
		//$data['sub_name']=$this->model_designation->fetch_subsidiary();
		$data['year_name']=$this->model_designation->fetch_year();

		$this->load->view('pages/CIL_hq_compare_data',$data);
		$this->load->view('templates/footer');
	}
	...
	{
		$data['values']=$this->model_designation->get_compare_for_CIL();
		...
		$data['year_name']=$temp6[0]["year_name"];
		//print_r($data['munit']);die();
		$this->load->view('pages/display_compare_for_CIL',$data);
	}

	public function get_compare_for_CIL_hq()
	{
		$data['values']=$this->model_designation->get_compare_for_CIL_hq();
		...
		$data['year_name']=$temp6[0]["year_name"];
		//print_r($data['munit']);die();
		$this->load->view('pages/display_compare_for_CIL_hq',$data);
	}
